...
# LINKFLAGS += -L/home/kbhetrr/workspace/Temporal-Safety/temporal-llvm/build/lib/generic
# LINKFLAGS += -lclang_rt.builtins-arm
# CFLAGS += --sysroot=$(SYSROOT)
# CXXFLAGS += --sysroot=$(SYSROOT)
# SYSROOT := /usr/lib/arm-none-eabi
# LINKFLAGS += -fuse-ld=lld --target=arm-none-eabi --sysroot=$(SYSROOT) \
#              -L/usr/lib/gcc/arm-none-eabi/10.3.1 \
#              -L$(SYSROOT)/lib/thumb/v8-m.main/nofp \
#              -L$(SYSROOT)/lib \
